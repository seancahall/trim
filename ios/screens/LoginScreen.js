...
import { login, changeField } from '../actions/authAction';
...
class LoginScreen extends React.Component {
    ...
    return (
      ...
      <Image
        ...
        style={styles.imageContainer}>
          ...
          <KeyboardAvoidingView behavior="padding" style={styles.inputWrap}>
        ...
        <TouchableOpacity activeOpacity={.5} onPress={this._barberLogin}>
          <View style={styles.forgotPasswordText}>
            <Text style={{ color: '#fff', backgroundColor: 'transparent', textAlign: 'center', fontWeight: 'bold', fontSize: 18 }}>Are you a barber logging in? <FontAwesome
              name='sign-in'
              size={20}
              color='#fff'
            /></Text>
 ...
 _barberLogin = () => {
    this.props.navigator.push('barberLogin')
  }
