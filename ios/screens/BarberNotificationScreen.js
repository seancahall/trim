...
export default class BarberNotificationScreen extends React.Component {
        ...
        <ScrollView>
          <View style={styles.container}>
            <View style={styles.wrapper}>
              ...
              <Text style={{ color: '#fff', backgroundColor: 'transparent', fontSize: 24, fontWeight: 'bold', textAlign: 'center' }}>-  AWAITING TRIM NOTIFICATION  -</Text>        
              <Text style={{ color: '#fff', backgroundColor: 'transparent', fontSize: 14, fontWeight: 'bold' }}></Text>
              <Text style={{ color: '#fff', backgroundColor: 'transparent', fontSize: 14}}></Text>
              <Text style={{ color: '#fff', backgroundColor: 'transparent', fontSize: 14}}></Text>
              <Text numberOfLines={5} style={{ color: '#fff', backgroundColor: 'transparent', fontSize: 14, fontWeight: 'bold' }}>
                {this.state.bodyText}
              </Text>
              </View>
              <TouchableOpacity activeOpacity={.5} onPress={this._barberPrompt}>
  ...
  _barberPrompt = () => {
    this.props.navigator.push('barberPrompt');
  }
  _barberToggle = () => {
